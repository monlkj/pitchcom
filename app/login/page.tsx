      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* 탭 */}
            <div style={{ display: 'flex', background: '#0f172a', borderRadius: 14, padding: 4, marginBottom: 24 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {tab === 'signup' && (
                <div>
                  <label style={{ fontSize: 12, color: '#64748b', fontWeight: 700, marginBottom: 6, display: 'block' }}>이름</label>
                  <input
                    type="text"
                    value={name}
              ...
              <div>
                <label style={{ fontSize: 12, color: '#64748b', fontWeight: 700, marginBottom: 6, display: 'block' }}>이메일</label>
                <input
                  type="email"
                  value={email}
              ...
              <div>
                <label style={{ fontSize: 12, color: '#64748b', fontWeight: 700, marginBottom: 6, display: 'block' }}>비밀번호</label>
                <input
                  type="password"
                  value={password}
              ...
              <button
                ...
                disabled={loading}
                style={{
                  marginTop: 4, padding: '15px', borderRadius: 13, border: 'none',
